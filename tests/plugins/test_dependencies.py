...
from opulence.common.plugins.exceptions import (
        BinaryDependencyMissing, DependencyMissing, 
        FileDependencyMissing, ModuleDependencyMissing)
...
class TestPluginDependencies(unittest.TestCase):
    ...
    def test_file_dep_ok(self):
        with patch('opulence.common.plugins.dependencies.os.path.isfile') as mock_isfile, \
            patch('opulence.common.plugins.dependencies.os.path.exists') as mock_exists:
